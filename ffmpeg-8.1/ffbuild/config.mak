...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cc=clang --disable-debug --disable-doc --disable-network --disable-ffplay --disable-ffprobe --disable-everything --disable-autodetect --disable-xlib --disable-videotoolbox --enable-zlib --enable-ffmpeg --enable-protocol=file --enable-demuxer=image2 --enable-decoder=png --enable-encoder=libwebp --enable-muxer=webp --enable-parser=png --enable-filter=scale --enable-filter=format --enable-libwebp --pkg-config-flags=--static --extra-cflags=-I/opt/homebrew/include --extra-ldflags=-L/opt/homebrew/lib --extra-libs=-lsharpyuv
prefix=/usr/local
...
CFLAGS=  -I/opt/homebrew/include -std=c17 -Werror=partial-availability -mdynamic-no-pic -fno-common -fomit-frame-pointer -fPIC -pthread  -I/opt/homebrew/opt/webp/include -I/opt/homebrew/opt/webp/include/webp -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wmissing-prototypes -Wstrict-prototypes -Wunterminated-string-initialization -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -Wno-microsoft-enum-forward-reference -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
ASFLAGS=  -I/opt/homebrew/include -mdynamic-no-pic -fPIC -Qunused-arguments
GLSLCFLAGS=
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -L/opt/homebrew/lib  -Wl,-dynamic,-search_paths_first -Wl,-no_warn_duplicate_libraries -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -L/opt/homebrew/opt/webp/lib -lwebp -lsharpyuv -lz
